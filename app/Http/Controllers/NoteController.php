...
class NoteController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if (Auth::user()->department->id != $note->department_id || Auth::user()->role->id == Role::ROLE_EMPLEADO) {
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('home')
            ->with('notes', $notes)
            ->with('success', 'La nota se ha actualizado exitosamente.');
    }
